...
const features = [
  {
    ...
    desc: 'Capture live conversations directly in your browser. No app install needed.',
  },
  {
    icon: '👥',
    title: 'Speaker diarization',
    desc: 'Automatically detects who is speaking and tracks each person separately.',
  },
  {
    icon: '📝',
    title: 'AI transcription',
    desc: 'Whisper AI transcribes every word, labelled by speaker, on your device.',
  },
  {
    icon: '🧠',
    title: 'Coaching insights',
    desc: 'Get actionable feedback on talk time, confidence, and conversation patterns.',
  },
]
